...
export default function UnderConstruction() {
  ...
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-2 mx-auto max-w-6xl p-4 py-4">
        <div className="md:py-32">
          <h1 className="text-4xl md:text-6xl  font-bold text-blue-300 mb-2">
      ...
      <div className="flex items-center justify-center mt-10">
        <p className="text-sm text-center pb-6">
          &copy; 2023 3-idiots | All rights reserved.
        </p>
      </div>
    </section>
  );
